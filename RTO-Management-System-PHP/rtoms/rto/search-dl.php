...
$sid=$_SESSION['sid'];
$cid=$_SESSION['cid'];
$ret=mysqli_query($con,"select * from tblldicence join users on users.id=tblldicence.UserId where StateID=$sid && CityID=$cid && ApplicationNumber like '%$sdata%' || users.FirstName like '%$sdata%'");
$cnt=1;
