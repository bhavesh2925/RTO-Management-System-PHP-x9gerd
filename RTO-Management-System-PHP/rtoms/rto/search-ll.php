...
<html lang="en">
    <head>
        ...
        <title>RTO Management System || Search Learning Licence Application</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Search Learning Licence Application</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Search Learning Licence Application</li>
                        </ol>
                        <div class="card mb-4">
...
$sid=$_SESSION['sid'];
$cid=$_SESSION['cid'];
$ret=mysqli_query($con,"select * from tblllicence join users on users.id=tblllicence.UserId where StateID=$sid && CityID=$cid && ApplicationNumber like '%$sdata%' || users.FirstName like '%$sdata%'");
$cnt=1;
