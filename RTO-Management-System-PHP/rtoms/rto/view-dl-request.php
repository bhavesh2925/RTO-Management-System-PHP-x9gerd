...
if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update   tblldicence set Status='$ressta',Remark='$remark' where ApplicationNumber='$appid'");
    if ($query) {
   
    echo '<script>alert("Driving license request Has been updated.")</script>';
    echo "<script type='text/javascript'> document.location ='all-dl-request.php'; </script>";
  }
  else
    {
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">View Driving Licence Details</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">View Driving Licence Details</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
<?php
