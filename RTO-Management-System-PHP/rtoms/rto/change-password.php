...
$query=mysqli_query($con,"select ID from tblrto where ID='$rid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tblrto set Password='$newpassword' where ID='$rid'");
