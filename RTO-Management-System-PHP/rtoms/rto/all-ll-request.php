            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">All Learning Licence Request</h1>
...
$sid=$_SESSION['sid'];
$cid=$_SESSION['cid'];
$ret=mysqli_query($con,"select * from tblllicence join users on users.id=tblllicence.UserId where StateID=$sid && CityID=$cid");
$cnt=1;
