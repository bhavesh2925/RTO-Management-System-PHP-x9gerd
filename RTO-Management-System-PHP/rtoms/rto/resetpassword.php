...
if(isset($_POST['submit']))
  {
    ...
    $password=md5($_POST['newpassword']);
        ...
        $query=mysqli_query($con,"update tblrto set Password='$password'  where  Username='$uname' and Nodalofficer='$noname' ");
   if($query)
   {
...
<html lang="en">
    <head>
        ...
        <title>RTO Management System - Reset Password</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4"> RTO-MS | RTO Reset Password</h3></div>
                                    <div class="card-body">
