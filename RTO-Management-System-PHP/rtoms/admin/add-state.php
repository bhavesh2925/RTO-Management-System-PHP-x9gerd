...
$sql=mysqli_query($con,"insert into tblstate(StateName) values('$statename')");
...
<html lang="en">
    <head>
        ...
        <title>RTO Management System - Add State</title>
...
<div class="col-4"><input type="text" placeholder="Enter State Name"  name="statename" class="form-control" required></div>
</div>
<div class="row">
