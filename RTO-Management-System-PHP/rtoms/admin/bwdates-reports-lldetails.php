            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Between Dates Reports Of Learing Licence</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Between Dates Reports Of Learing Licence</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                               Between Dates Reports Of Learing Licence
                            </div>
                            <?php
...
<hr />
                            ...
                            <div class="card-body">
                                <h4 align="center" style="color:blue">Report from <?php echo $fdate?> to <?php echo $tdate?> of All Learning Licence of RTO <?php echo $rtoname?></h4>
